...
parser.add_argument('--base_model', choices=['llama3', 'llama2'], default='llama3')
...
for i in range(num_p):
    ...
    if args.base_model == 'llama2':
        command = "python ge_data/ge_data_all_llama2chat.py --start={} --end={} --index={} --gpu_index {} --outdir {} --data_path {} --model_path {}".format(start, end, index,
                                                                                                gpu_index_str, outdir, args.data_path, args.model_path)
    else:
        command = "python ge_data/ge_data_all_llama3.py --start={} --end={} --index={} --gpu_index {} --outdir {} --data_path {} --model_path {}".format(start, end, index,
                                                                                                gpu_index_str, outdir, args.data_path, args.model_path)
