...
ckpt=/home/jovyan/workspace/project/lora-from-hass/checkpoint
mkdir -p $ckpt
...
CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --main_process_port 29501 -m --mixed_precision=bf16 train.main_hass_lora \
    --basepath $BasePath \
    --tmpdir $prep \
    --cpdir $ckpt \
