CUDA_VISIBLE_DEVICES=0 python -m evaluation.gen_manual_attn_lora_ea_answer_llama3chat \
	--ea-model-path /home/jovyan/workspace/project/manual-attn-lora-from-eagle/checkpoint/state_11 \
	...
	--temperature 0 \
	--model-id manual-attn-lora-from-eagle-epoch11 &
