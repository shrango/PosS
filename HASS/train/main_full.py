...
from model.cnets_full import Model
...
model = Model(config, load_emb=True, path=args.basepath, forward_num_total=args.forward_num_total)
...
if args.ckpt_path is not None: 
    ...
    for i in range(1, args.forward_num_total):
