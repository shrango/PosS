...
ckpt=/home/jovyan/workspace/project/manual-lora-from-hass50/checkpoint
mkdir -p $ckpt
...
restore_from=/home/jovyan/workspace/project/hass-from-hass/checkpoint/state_10

CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --main_process_port 29500 -m --mixed_precision=bf16 train.main_hass_manual_lora \
    --basepath $BasePath \
    --tmpdir $prep \
    --cpdir $ckpt \
