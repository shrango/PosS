...
ckpt=/home/jovyan/workspace/project/lora-from-eagle/checkpoint
mkdir -p $ckpt
...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch -m --mixed_precision=bf16 train.main_hass_lora \
    --basepath $BasePath \
    --tmpdir $prep \
    --cpdir $ckpt \
