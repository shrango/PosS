...
from .cnets_manual_attn_lora_gen import Model
...
class EaModel(nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            bias=True
        self.ea_layer = Model(config,bias=bias,total_tokens=total_token,depth=depth,top_k=top_k,threshold=threshold,forward_num_total=depth+1)
