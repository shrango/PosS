...
class Model(nn.Module):
    ...
    def topK_genrate(self, hidden_states, input_ids, head, logits_processor,max_length=4, use_cache=True):
        ...
        if use_cache:
            ...
            last_headout = self(hidden_states, input_ids=input_ids, use_cache=True)[:, -1]
            ...
            for i in range(len(self.tree_buffer['tree_indices'])):
                ...
                last_headout = self(hidden_states, input_ids=input_ids, use_cache=True)[0]
